...
Here is how you would estimate a regression model in R that would predict the
Exam score based on time spent studying (where both of these variables are
